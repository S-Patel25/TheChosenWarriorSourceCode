...
namespace ChosenWarriorGameplayTags
{
	/* Input Tags! */
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Rage_Full, "Player.Rage.Full");
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Rage_None, "Player.Rage.None");
